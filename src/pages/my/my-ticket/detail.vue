<template>
  <view class="koa-ticket-book uni-container">
    ...
    <view class="uni-panel">
      <uni-list>
        <uni-list-item :show-arrow="false" :title="'Order date:'+order.date"/></uni-list-item>
        <uni-list-item :show-arrow="false" :title="'Order Number:'+order.number"/></uni-list-item>
        <uni-list-item
          :show-arrow="false"
          :showExtra="true"
         >
    ...
    export default {
        ...
        onLoad(options) {
          setTimeout(()=>{
            ...
            this.ticketSum = this.order.adult.money2 * this.order.adult.ticketNum +

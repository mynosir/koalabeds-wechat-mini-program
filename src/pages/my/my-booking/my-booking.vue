<template>
    <view class="tabs">
        ...
        <swiper :current="tabIndex" class="swiper-box" style="flex: 1;" :duration="300" @change="ontabchange">
            ...
            <booking-order :list="tab.data" @click="showProduct" @book="goBook" @cancel="cancelBook(index1,tab.data)"></booking-order>
				</scroll-view>
				<!-- #endif -->
            </swiper-item>
        </swiper>
        ...
        <uni-popup ref="popup" type="bottom">
            ...
            <view class="uni-media-list" style="top: 15px;padding: 15rpx 0;">
              ...
              <view class="uni-media-list-body" style='display: block;height: 142rpx;'>
                ...
                <view class="uni-media-list-text-top" style='font-size: 23rpx'>IN:{{popHotel.startDate}} END:{{popHotel.endDate}} {{popHotel.dayCount}}N</view>
            ...
            <view class="uni-panel" style="margin:60upx 0 80upx">
              ...
              <view class="example-body">
                Rating:<uni-rate style="margin-left:20px" :value="2" @change="onChange" />
              </view>
              <view class="uni-textarea">
        				<textarea @blur="bindTextAreaBlur" :value="popHotel.textAreaValue" style='border: 1px solid gray' placeholder-style="color:black" placeholder="Share your experience.."/>
        			</view>
            </view>
